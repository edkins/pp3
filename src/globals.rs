...
impl Default for Globals {
    fn default() -> Self {
        let mut globals = vec![GlobalInfo{arity:0,name:String::new()};PRELUDE_MAX];
        globals[FALSE.index()] = GlobalInfo{arity:0, name:"false".to_owned()};
        globals[TRUE.index()] = GlobalInfo{arity:0, name:"true".to_owned()};
        globals[IMP.index()] = GlobalInfo{arity:2, name:"imp".to_owned()};
        globals[AND.index()] = GlobalInfo{arity:2, name:"and".to_owned()};
